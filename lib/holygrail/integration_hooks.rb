  ...
  module HolyGrail
    module IntegrationHooks
      ...
      def self.included(base)
        base.class_eval do
          alias_method_chain :process, :harmony
        end
      end
      ...
      #
      # @private
      def process_with_harmony(*args) #:nodoc:
        @__page = nil
        process_without_harmony(*args)
      end
      ...
      #
      def js(code)
        @__page ||= Harmony::Page.new(rewrite_script_paths(body.to_s))
